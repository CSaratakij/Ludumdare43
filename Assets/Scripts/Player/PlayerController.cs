...
namespace Ludumdare43
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public bool IsHasBeenThrowed { get { return isHasBeenThrowed; } }
        ...
        public Color Color { get { return playerColorMaterial[PlayerIndex].color; } }
        ...
        public void Pickup(PlayerController target, bool value)
        {
            ...
            if (value) {
                ...
                //Hacks
                if (target.IsTarget) {
                    SacrificeController.PickupTargetPos = transform.position;
                }
            }
